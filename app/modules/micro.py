...
def find_coords(macro_cell, micro_step=10):
    """
    ...
    half_size = macro_cell._size  # так как макро-квадрат 1000м
    ...
    for x in x_coords:
        for y in y_coords:
            ...
            intersecting_edges = gdf_edges[gdf_edges.intersects(micro_box)]
            ...
            intersecting_nodes = gdf_nodes[gdf_nodes.intersects(micro_box)]
...
x_coords = np.arange(minx, maxx + 1000, 1000)
y_coords = np.arange(maxy, miny - 1000, - 1000)
